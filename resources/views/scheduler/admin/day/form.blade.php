    ...
    <div id="content" class="padding-20">
        <div id="panel-1" class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <form action="{{ route($url,$day->id ?? '') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @if (isset($day))
                        @method('put')
                    @endif
                        ...
                        <div class="row">
                            <div class="form-group">
                                <div class="col-sm-offset-3 col-md-offset-3 col-md-6 col-sm-6">
                                    <label>Hari</label>
                                    <input type="text" class="form-control" name="name" value="{{old('name')?? $day->name ?? '' }}">
                                    @error('name')
                        ...
                        <div class="row">
                            <div class="form-group">
                                <div class="col-sm-offset-3 col-md-offset-3 col-md-6 col-sm-6">
                                    ...
                                    <input type="number" class="form-control" name="slot" value="{{old('slot')?? $day->slot ?? ''}}">
                                    @error('slot')
